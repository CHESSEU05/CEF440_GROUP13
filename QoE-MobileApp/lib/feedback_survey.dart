              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _canSubmit() ? primaryColor : subtleTextColor.withOpacity(0.6),
                  ...
                  onPressed: _canSubmit()
                    ...
                    print('Overall Experience: ${_ratings[0]}');
                    print('Internet Speed: ${_ratings[1]}');
                    print('Connection Stability: ${_ratings[2]}');
                    print('Call Quality: ${_ratings[3]}');
                    print('Additional Thoughts: ${_thoughtsController.text}');
